...
while (guestList.length > 2) {
    ...
    console.log("Sorry ".concat(removeGuest, " I can Invite you to dinner"));
}
//Sending a invitation to the last two guest on the list
console.log("\nInvitations  to the last 2 Guests\n ");
guestList.forEach(function (lasttwo) { return console.log("Luckly ".concat(lasttwo, ", you are still invite to dinner ")); });
